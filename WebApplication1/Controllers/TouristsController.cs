...
namespace WebApplication1.Controllers
{
    public class TouristsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LastName,FirstName,SurName,BirthDay,Address,Number")] Tourist tourist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LastName,FirstName,SurName,BirthDay,Address,Number")] Tourist tourist)
        {
            if (id != tourist.Id)
            {
                return NotFound();
