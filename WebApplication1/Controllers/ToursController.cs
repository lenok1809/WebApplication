...
namespace WebApplication1.Controllers
{
    public class ToursController : Controller
    {
        ...
        {
            if (id == null) return RedirectToAction("Hotels", "Index");
            ViewBag.HotelId = id;
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["HotelId"] = new SelectList(_context.Hotels, "Id", "Id", tour.HotelId);
            ViewData["ManegerId"] = new SelectList(_context.Managers, "Id", "Id", tour.ManegerId);
            return View(tour);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TourName,TourDuration,ManegerId,HotelId")] Tour tour)
        {
            if (id != tour.Id)
            {
                return NotFound();
