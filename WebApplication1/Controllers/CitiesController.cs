...
namespace WebApplication1.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //return View(city);
            return RedirectToAction("Index", "Hotels", new { id = city.Id, name = city.Name });
        }
        ...
        public async Task<IActionResult> Create(int countryId,[Bind("Id,Name,CountryId")] City city)
        {
